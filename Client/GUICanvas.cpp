...
void GUICanvas::render(GUIRenderer& guiRenderer, GUIShader& guiShader, GUIFontShader& fontShader, std::vector<GUIFont>& fonts, const glm::mat4& matrix) {
	renderGUI(guiRenderer, guiShader, matrix);
	renderFonts(fontShader, fonts, matrix);
}

void GUICanvas::renderGUI(GUIRenderer& guiRenderer, GUIShader& guiShader, const glm::mat4& matrix){
...
void GUICanvas::renderFonts(GUIFontShader& fontShader, std::vector<GUIFont>& fonts, const glm::mat4& matrix){
	fontShader.bind();
